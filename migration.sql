...
ALTER TABLE gallery MODIFY COLUMN title VARCHAR(1024);
ALTER TABLE gallery MODIFY COLUMN title_jpn VARCHAR(1024);
ALTER TABLE gallery MODIFY COLUMN uploader VARCHAR(1024);
